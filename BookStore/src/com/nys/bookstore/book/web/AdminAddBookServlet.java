...
public class AdminAddBookServlet extends HttpServlet {
    ...
    // 上传文件存储目录
    private static final String UPLOAD_DIRECTORY = "/book_img";
...
//        System.out.println(param);
        ...
        request.getServletContext().getRequestDispatcher("/adminBook?method=findAll").forward(
                request, response);
    }
